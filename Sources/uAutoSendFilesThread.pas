  ...
  try
    try
      ...
      begin
        ...
        begin
          ForceDirectories(ExcludeTrailingPathDelimiter(ExcludeTrailingPathDelimiter(ExcludeTrailingPathDelimiter(sDstDir))));
        end;
...
begin
  try
    ...
    qryInsertIntoAutoSendFilesThread.SQL.Add(QuotedStr(ExcludeTrailingPathDelimiter(ExcludeTrailingPathDelimiter(ExcludeTrailingPathDelimiter(sDst)))) + ', ');
