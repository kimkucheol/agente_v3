[Setup]
#define AppVersion GetFileVersion("Z:\GitHub\agente_v3\Sources\Win32\Debug\hosannaagente20.exe")
...
SetupIconFile=Z:\GitHub\agente_v3\Sources\Setup\easy.ico
Compression=lzma
...
;OutputDir=Z:\GitHub\agente_v3\Sources\Setup\
...
[Files]
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\hosannaagente20.exe; DestDir: {app}; Flags: ignoreversion
...
;OCX VAX
Source: Z:\GitHub\agente_v3\Sources\Setup\VaxSIPUserAgentOCX.ocx; DestDir: {sys}; Flags: restartreplace sharedfile regserver

;Biblioteca MySQL
Source: Z:\GitHub\agente_v3\Sources\Setup\libmySQL55.dll; DestDir: {sys}; Flags: onlyifdoesntexist uninsneveruninstall
Source: Z:\GitHub\agente_v3\Sources\Setup\libmySQL41.dll; DestDir: {sys}; Flags: onlyifdoesntexist uninsneveruninstall
Source: Z:\GitHub\agente_v3\Sources\Setup\libmySQL50.dll; DestDir: {sys}; Flags: onlyifdoesntexist uninsneveruninstall
Source: Z:\GitHub\agente_v3\Sources\Setup\libmySQL51.dll; DestDir: {sys}; Flags: onlyifdoesntexist uninsneveruninstall

;Skin
Source: Z:\GitHub\agente_v3\Sources\Setup\skin\WLM.asz; DestDir: {app}\skin; Flags: onlyifdoesntexist ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Setup\skin\iOS4.asz; DestDir: {app}\skin; Flags: onlyifdoesntexist ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Setup\skin\WEB2.asz; DestDir: {app}\skin; Flags: onlyifdoesntexist ignoreversion

;INI Padrao
Source: Z:\GitHub\agente_v3\Sources\Setup\Config.INI; DestDir: {app}; Flags: ignoreversion

;IMGs
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\icoChat.png; DestDir: {app}\img; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\icoChatDiscar2.png; DestDir: {app}\img; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\icoChatEncerrar.png; DestDir: {app}\img; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\icoChatURL2.png; DestDir: {app}\img; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\icoHosanna.png; DestDir: {app}\img; Flags: ignoreversion

;IMGs E-Mail
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\EMail\facebook.png; DestDir: {app}\img\EMail; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\EMail\arrowLeft.png; DestDir: {app}\img\EMail; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\EMail\paperclip.png; DestDir: {app}\img\EMail; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\EMail\adminUser.png; DestDir: {app}\img\EMail; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\EMail\magnify.png; DestDir: {app}\img\EMail; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\EMail\bubbles2.png; DestDir: {app}\img\EMail; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\EMail\mail.png; DestDir: {app}\img\EMail; Flags: ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Win32\Debug\img\EMail\twitter.png; DestDir: {app}\img\EMail; Flags: ignoreversion

;Dic
Source: Z:\GitHub\agente_v3\Sources\Setup\Dic\Dic.cfg; DestDir: {app}\dic; Flags: onlyifdoesntexist ignoreversion
Source: Z:\GitHub\agente_v3\Sources\Setup\Dic\brazport.adm; DestDir: {app}\dic; Flags: onlyifdoesntexist

;Audio
Source: Z:\GitHub\agente_v3\Sources\Setup\Ring.wav; DestDir: {app}; Flags: ignoreversion
...
;Video Codec
Source: Z:\GitHub\agente_v3\Sources\Setup\ffdshow-20041012.exe; DestDir: {app}\lib; AfterInstall: AfterMyProgInstall_FFD('ffdshow-20041012.exe'); Flags: ignoreversion

;TeamViewer
Source: Z:\GitHub\agente_v3\Sources\Setup\TeamViewerQS_pt-idchesmr8e.exe; DestDir: {app}\lib; Flags: ignoreversion

;OEM
Source: Z:\GitHub\agente_v3\Sources\Setup\Lang\appsHT.dll; DestDir: {app}\lang; Flags: ignoreversion
